...
func (h *handlerTracker) DeleteChannelV1(context.Context, Call, io.Writer) error {
	h.deleteChannelV1++
	return nil
}
...
func (c *chatEcho) DeleteChannelV1(context.Context, deleteChannelOptionsV1) Reply {
	return Reply{Result: echoOK}
}
